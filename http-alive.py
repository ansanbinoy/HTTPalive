				...
				if self.pro == "http" or self.pro == "https":
					...
					try :
						...
						if self.options.sort.lower() == "all":
							if code[0] == "2":
								print (self.B+"[+] "+self.G+url+self.B+"\n\t\t\t\t\t [+] "+self.G+code)
							elif code[0] == "3":
								print (self.B+"[+] "+self.G+url+self.B+"\n\t\t\t\t\t [+] "+self.B+code)
							elif code[0] == "4":
								print (self.B+"[+] "+self.G+url+self.B+"\n\t\t\t\t\t [+] "+self.R+code)
							...
							if code[0] == "2":
								print (self.B+"[+] "+self.G+url+self.B+"\f\t\t\t[+] "+self.G+code)
						elif self.options.sort.lower() == "3xx":
							if code[0] == "3":
								print (self.B+"[+] "+self.G+url+self.B+"\f\t\t\t[+] "+self.B+code)
						elif self.options.sort.lower() == "4xx":
							if code[0] == "4":
								print (self.B+"[+] "+self.G+url+self.B+"\f\t\t\t[+] "+self.R+code)
						elif self.options.sort.lower() == "5xx":
							if code[0] == "5":
								print (self.B+"[+] "+self.G+url+self.B+"\f\t\t\t[+] "+self.Y+code)
					except KeyboardInterrupt:
						print (self.R+"Exiting ..")
						print (W)
						sys.exit()
					except :
						print (self.B+"[+] "+self.G+url+self.B+"\n\t\t\t\t\t [~] "+self.R+"Url not found")
				elif self.pro == "na":
					url = i
					try :
						x = requests.get(url)
